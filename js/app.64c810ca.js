(function (A) {
  function i(i) {
    for (
      ...
      (n = M[o]),
        Object.prototype.hasOwnProperty.call(I, n) && I[n] && v.push(I[n][0]),
        (I[n] = 0);
                  ...
                  c("li", [
                    ...
                    c("span", [
                      c(
                        ...
                        {
                          attrs: {
                            href: "https://github.com/sowon901",
                            target: "_blank",
                          },
                        },
                        [A._v("github.com/sowon901")]
                      ),
                    ]),
                  ]),
                ]),
      ...
      j = [
        function () {
          ...
          return t("div", { attrs: { id: "viewIntroduce" } }, [
            ...
            t("div", [
              A._v("웹 백엔드 개발자 최소원입니다."),
              t("br"),
              A._v(
                " 대학교 3학년, 앱 프로젝트를 진행하면서 개발에 점차 흥미를 가지게 되었습니다."
              ),
              t("br"),
              A._v(
              ...
              t("br"),
              A._v(
                " 졸업 후 신세계아이앤씨 Java 백엔드 개발자 과정에 입과하여 IT 지식을 학습하고 프로젝트 경험을 쌓았습니다다."
              ),
              t("br"),
              A._v(
                " 짧은 기간이었지만 예술의 전당에서 결제 시스템 품질관리 테스터를 수행하며 안정적인 서비스의 중요성을 깨닫게 되었습니다."
              ),
              t("br"),
              A._v(
                " 이를 계기로 현재, 안정적인 서비스를 제공하는 개발자로 성장하기 위해 노력 중입니다."
              ),
              t("br"),
              t("a"),
            ]),
